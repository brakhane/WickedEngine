...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_VISIBILITY_ANALYZE,
		CSTYPE_VISIBILITY_ANALYZE_MSAA,
		CSTYPE_VISIBILITY_RESOLVE_UNIFORM,
		CSTYPE_VISIBILITY_RESOLVE_DIVERGENT,
		CSTYPE_VISIBILITY_RESOLVE_UNIFORM_BINNING,
		CSTYPE_VISIBILITY_RESOLVE_DIVERGENT_BINNING,
		CSTYPE_VISIBILITY_SKY_UNIFORM,
		CSTYPE_VISIBILITY_SKY_DIVERGENT,
		CSTYPE_VISIBILITY_VELOCITY_UNIFORM,
		CSTYPE_VISIBILITY_VELOCITY_DIVERGENT,
		CSTYPE_VISIBILITY_SURFACE_REDUCED_UNIFORM_PERMUTATION_BEGIN,
		CSTYPE_VISIBILITY_SURFACE_REDUCED_UNIFORM_PERMUTATION_END = CSTYPE_VISIBILITY_SURFACE_REDUCED_UNIFORM_PERMUTATION_BEGIN + SHADERTYPE_BIN_COUNT,
		CSTYPE_VISIBILITY_SURFACE_REDUCED_DIVERGENT_PERMUTATION_BEGIN,
		CSTYPE_VISIBILITY_SURFACE_REDUCED_DIVERGENT_PERMUTATION_END = CSTYPE_VISIBILITY_SURFACE_REDUCED_DIVERGENT_PERMUTATION_BEGIN + SHADERTYPE_BIN_COUNT,
		CSTYPE_VISIBILITY_SURFACE_UNIFORM_PERMUTATION_BEGIN,
		CSTYPE_VISIBILITY_SURFACE_UNIFORM_PERMUTATION_END = CSTYPE_VISIBILITY_SURFACE_UNIFORM_PERMUTATION_BEGIN + SHADERTYPE_BIN_COUNT,
		CSTYPE_VISIBILITY_SURFACE_DIVERGENT_PERMUTATION_BEGIN,
		CSTYPE_VISIBILITY_SURFACE_DIVERGENT_PERMUTATION_END = CSTYPE_VISIBILITY_SURFACE_DIVERGENT_PERMUTATION_BEGIN + SHADERTYPE_BIN_COUNT,
		CSTYPE_VISIBILITY_SHADE_UNIFORM_PERMUTATION_BEGIN,
		CSTYPE_VISIBILITY_SHADE_UNIFORM_PERMUTATION_END = CSTYPE_VISIBILITY_SHADE_UNIFORM_PERMUTATION_BEGIN + SHADERTYPE_BIN_COUNT,
		CSTYPE_VISIBILITY_SHADE_DIVERGENT_PERMUTATION_BEGIN,
		CSTYPE_VISIBILITY_SHADE_DIVERGENT_PERMUTATION_END = CSTYPE_VISIBILITY_SHADE_DIVERGENT_PERMUTATION_BEGIN + SHADERTYPE_BIN_COUNT,
